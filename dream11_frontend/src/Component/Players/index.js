    ...
    let tagList = searchPlayer.map(function(value,index)
    {
        ...
        if(!this.handleCheck(value) ){
            ...
            <div className="content">
                <div className="text">
                    <Link to={`/dream11/core/login/loggedIN/profile/${value.name}/${value.country}`} >{value.name}</Link>
    ...
    let wicketkeeperGeseGa =addedWkt.map(function (value,index)
    {
        return  <div class="column">
            ...
            <div className="cards">
                ...
                <Link to={`/dream11/core/login/loggedIN/profile/${value.name}/${value.country}/`} >
